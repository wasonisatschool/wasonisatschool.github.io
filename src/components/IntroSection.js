          ...
          <div id="custom-1795-particle" className="g-content g-particle">
            <div className="conference-cta">
              <a href="/public-law-and-cities-2024" title="First Taiwan Chapter Conference">
                <img className="size-full" src="https://www.icon-society.at/media/2023/11/Public-Law-and-the-Cities-Banner-no-registration.jpg" alt="Public Law and Cities Banner" width="1920" height="500" />
